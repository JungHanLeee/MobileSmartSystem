...
broker_address = "192.168.137.128"  #input("브로커 IP>>")  
...
Button(controlFrame, text="Reverse Gear", overrelief="solid", width=15, command=onDistance).pack(side=TOP)
...
while(isRunning):
	...
	if(myqueue.empty() == False):
		...
		redLeftLine = canvas.create_line(150,450,180,350,fill="red")
		redTopLine = canvas.create_line(180,350,540,350,fill="red")
		redRightLine = canvas.create_line(540,350,570,450,fill="red")
		greenLeftLine = canvas.create_line(180,350,210,250,fill="green")
		greenTopLine = canvas.create_line(210,250,510,250,fill="green")
		greenRightLine = canvas.create_line(540,350,510,250,fill="green")
